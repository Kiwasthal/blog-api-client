...
const Navbar = ({ userAuth, updateUserAuth, username }) => {
      ...
      <nav className="flex items-center justify-between px-4 py-3 bg-gray-900 ">
        <Link href="/">
          <div className="flex items-center cursor-pointer">
            ...
            <span className="text-white text-3xl text-extrabold">BLOG-APP</span>
          </div>
        </Link>
